...
function spa_scripts() {
	...
	wp_enqueue_script( 'spa-navigation', get_template_directory_uri() . 'static/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'spa-skip-link-focus-fix', get_template_directory_uri() . 'static/js/skip-link-focus-fix.js', array(), '20151215', true );
